...
SECRET_KEY = "django-insecure-x!#rr)p5of-mo&-sw!(7+a%!&870i=cco%=y_1f5rd$ai=p_*@"
...
ROOT_URLCONF = "google_drive_app.urls"
...
WSGI_APPLICATION = "google_drive_app.wsgi.application"
